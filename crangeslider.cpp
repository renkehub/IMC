...
{
  Q_DECLARE_PUBLIC(CRangeSlider)
protected:
  CRangeSlider* const q_ptr;
public:
  ...
  CRangeSliderPrivate(CRangeSlider& object);
  void init();
  ...
  CRangeSliderPrivate::Handles m_SelectedHandles;
...
private:
  Q_DISABLE_COPY(CRangeSliderPrivate);
};

// --------------------------------------------------------------------------
CRangeSliderPrivate::CRangeSliderPrivate(CRangeSlider& object)
  :q_ptr(&object)
{
...
// --------------------------------------------------------------------------
CRangeSliderPrivate::Handle CRangeSliderPrivate::handleAtPos(const QPoint& pos, QRect& handleRect)const
{
  Q_Q(const CRangeSlider);
...
//
int CRangeSliderPrivate::pixelPosToRangeValue( int pos ) const
{
  Q_Q(const CRangeSlider);
  QStyleOptionSlider option;
  q->initStyleOption( &option );
...
//---------------------------------------------------------------------------
int CRangeSliderPrivate::pixelPosFromRangeValue( int val ) const
{
  Q_Q(const CRangeSlider);
  QStyleOptionSlider option;
  q->initStyleOption( &option );
...
void CRangeSliderPrivate::drawMinimumSlider( QStylePainter* painter ) const
{
  Q_Q(const CRangeSlider);
  QStyleOptionSlider option;
...
void CRangeSliderPrivate::drawMaximumSlider( QStylePainter* painter ) const
{
  Q_Q(const CRangeSlider);
  QStyleOptionSlider option;
...
// --------------------------------------------------------------------------
CRangeSlider::CRangeSlider(QWidget* _parent)
  : QSlider(_parent)
  , d_ptr(new CRangeSliderPrivate(*this))
{
  Q_D(CRangeSlider);
  d->init();
}
...
// --------------------------------------------------------------------------
CRangeSlider::CRangeSlider( Qt::Orientation o,
...
// --------------------------------------------------------------------------
CRangeSlider::CRangeSlider(CRangeSliderPrivate* impl, QWidget* _parent)
  : QSlider(_parent)
  , d_ptr(impl)
{
  Q_D(CRangeSlider);
...
// --------------------------------------------------------------------------
CRangeSlider::CRangeSlider( CRangeSliderPrivate* impl, Qt::Orientation o,
                                QWidget* parentObject )
  :QSlider(o, parentObject)
  , d_ptr(impl)
{
...
// --------------------------------------------------------------------------
int CRangeSlider::minimumValue() const
{
  Q_D(const CRangeSlider);
  return d->m_MinimumValue;
}

// --------------------------------------------------------------------------
void CRangeSlider::setMinimumValue( int min )
{
  Q_D(CRangeSlider);
...
// --------------------------------------------------------------------------
int CRangeSlider::maximumValue() const
{
  Q_D(const CRangeSlider);
...
// --------------------------------------------------------------------------
void CRangeSlider::setMaximumValue( int max )
{
  Q_D(CRangeSlider);
...
// --------------------------------------------------------------------------
void CRangeSlider::setValues(int l, int u)
{
  Q_D(CRangeSlider);
  const int minValue =
...
// --------------------------------------------------------------------------
int CRangeSlider::minimumPosition() const
{
  Q_D(const CRangeSlider);
...
// --------------------------------------------------------------------------
int CRangeSlider::maximumPosition() const
{
  Q_D(const CRangeSlider);
...
// --------------------------------------------------------------------------
void CRangeSlider::setMinimumPosition(int l)
{
  Q_D(const CRangeSlider);
...
// --------------------------------------------------------------------------
void CRangeSlider::setMaximumPosition(int u)
{
  Q_D(const CRangeSlider);
...
// --------------------------------------------------------------------------
void CRangeSlider::setPositions(int min, int max)
{
  Q_D(CRangeSlider);
...
// --------------------------------------------------------------------------
void CRangeSlider::setSymmetricMoves(bool symmetry)
{
  Q_D(CRangeSlider);
...
// --------------------------------------------------------------------------
bool CRangeSlider::symmetricMoves()const
{
  Q_D(const CRangeSlider);
...
// --------------------------------------------------------------------------
void CRangeSlider::onRangeChanged(int _minimum, int _maximum)
{
  Q_UNUSED(_minimum);
  Q_UNUSED(_maximum);
  Q_D(CRangeSlider);
...
// --------------------------------------------------------------------------
// Render
void CRangeSlider::paintEvent( QPaintEvent* )
{
  Q_D(CRangeSlider);
  QStyleOptionSlider option;
...
void CRangeSlider::mousePressEvent(QMouseEvent* mouseEvent)
{
  Q_D(CRangeSlider);
  ...
  QRect handleRect;
  CRangeSliderPrivate::Handle handle_ = d->handleAtPos(mouseEvent->pos(), handleRect);

  if (handle_ != CRangeSliderPrivate::NoHandle)
    {
	d->isMoved = false;
    d->m_SubclassPosition = (handle_ == CRangeSliderPrivate::MinimumHandle)?
  ...
  if (control == QStyle::SC_SliderGroove &&
    ...
    if (!this->isMinimumSliderDown() || !this->isMaximumSliderDown())
      {
      d->m_SelectedHandles =
        QFlags<CRangeSliderPrivate::Handle>(CRangeSliderPrivate::MinimumHandle) |
        QFlags<CRangeSliderPrivate::Handle>(CRangeSliderPrivate::MaximumHandle);
...
// --------------------------------------------------------------------------
// Standard Qt UI events
void CRangeSlider::mouseMoveEvent(QMouseEvent* mouseEvent)
{
  ...
  this->blockSignals(false);
  emit valuesChanged(d->m_MinimumValue,
      d->m_MaximumValue,true);
  mouseEvent->accept();
}

// --------------------------------------------------------------------------
// Standard Qt UI mouseEvents
void CRangeSlider::mouseReleaseEvent(QMouseEvent* mouseEvent)
{
  Q_D(CRangeSlider);
  ...
  d->m_SelectedHandles = CRangeSliderPrivate::NoHandle;

  this->update();
}

// --------------------------------------------------------------------------
bool CRangeSlider::isMinimumSliderDown()const
{
  Q_D(const CRangeSlider);
  return d->m_SelectedHandles & CRangeSliderPrivate::MinimumHandle;
}

// --------------------------------------------------------------------------
bool CRangeSlider::isMaximumSliderDown()const
{
  Q_D(const CRangeSlider);
  return d->m_SelectedHandles & CRangeSliderPrivate::MaximumHandle;
}

// --------------------------------------------------------------------------
void CRangeSlider::initMinimumSliderStyleOption(QStyleOptionSlider* option) const
{
  this->initStyleOption(option);
}

// --------------------------------------------------------------------------
void CRangeSlider::initMaximumSliderStyleOption(QStyleOptionSlider* option) const
{
  this->initStyleOption(option);
}

// --------------------------------------------------------------------------
QString CRangeSlider::handleToolTip()const
{
  Q_D(const CRangeSlider);
...
// --------------------------------------------------------------------------
void CRangeSlider::setHandleToolTip(const QString& _toolTip)
{
  Q_D(CRangeSlider);
...
// --------------------------------------------------------------------------
bool CRangeSlider::event(QEvent* _event)
{
  Q_D(CRangeSlider);
  switch(_event->type())
    {
